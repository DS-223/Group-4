...
OPTIONAL_TABLES = ['predictions']  # prediction may be empty initially
    ...
    with engine.connect() as conn:
        ...
        for table in OPTIONAL_TABLES:
            if table in existing_tables:
                print(f"Optional table '{table}' found (may be empty).")
            else:
                print(f"Optional table '{table}' not found (will be created by model).")
